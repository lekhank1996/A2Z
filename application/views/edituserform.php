        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-warning">
                    ...
                    <form method="POST" action="<?php echo base_url(); ?>user/update" enctype="multipart/form-data" id="change_pass_form" >
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group col-md-4" id="username_div">
                                        ...
                                        <input type="text" name="username" id="username" class="form-control" value="<?php echo $user_data[0]['username']; ?>" />
                                        <input type="hidden" name="user_id" value="<?php echo $user_data[0]['user_id'];?>" id="id" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-4" id="password_div">
                                        ...
                                        <input type="password" name="password" id="password" class="form-control" value="<?php echo $user_data[0]['password']; ?>"/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-4" id="firstname_div">
                                        ...
                                        <input type="text" name="firstname" id="firstname" class="form-control" value="<?php echo $user_data[0]['firstname']; ?>"/>
                                        <div id="err_msg_op"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-4" id="lastname_div">
                                        ...
                                        <input type="text" name="lastname" id="lastname" class="form-control" value="<?php echo $user_data[0]['lastname'] ?>"/>
                            ...
                            <div class="box-footer">
                                ...
                                <input name="btn" id="btnsubmit" class="btn btn-success" type="submit" value="Update"   >
                                <a href="<?php echo site_url('user'); ?>"><button class="btn btn-warning" type="button">Cancel</button></a>
                            </div>
